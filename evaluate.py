...
# ── TEST QUESTIONS ─────────────────────────────────────────────────────────
# All based on articles in the knowledge base
TEST_QUESTIONS = [
...
c1 = build_collection("naive_rag",      chunk_size=500,  chunk_overlap=0)
c2 = build_collection("optimized_rag",  chunk_size=1000, chunk_overlap=200)
c3 = build_collection("multiquery_rag", chunk_size=1000, chunk_overlap=200)
...
print("Share evaluation_results.csv to generate the case study.")